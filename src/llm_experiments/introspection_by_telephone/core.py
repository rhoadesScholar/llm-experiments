class Context:
    ...
    def __repr__(self):
        return f"Context({self.context_str}, embodied={self.is_embodied}, AI_assistant={self.is_AI_assistant})"
...
class Conversation:
    """
    This class keeps track of all exchanges in a conversation, and formulates prompts for the LLM.
    """
    ...
    def formulate_prompt(
        ...
        """
        Formulates a prompt for the LLM based on the conversation history and context.
        """
