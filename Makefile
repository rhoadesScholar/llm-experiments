...
test-cov:
	pytest tests/ --cov=llm_experiments --cov-report=html --cov-report=term-missing --cov-report=xml
...
# Version info
version:
	python -c "import llm_experiments; print(llm_experiments.__version__)" 2>/dev/null || echo "Package not installed"
